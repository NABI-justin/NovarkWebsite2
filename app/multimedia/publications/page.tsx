"use client";
// Page placeholder pour la section Publications PDF.
    ...
    <div style={{ background: "#fff", minHeight: "100vh", fontFamily: "Arial, sans-serif", color: "#111" }}>
      ...
      <section style={{ background: "#0D1B3E", padding: "60px 40px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", maxWidth: 520, lineHeight: 1.8 }}>
            Téléchargez nos publications scientifiques, rapports et documents techniques. Cette section sera disponible prochainement.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 40px", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 14, color: "#aaa", lineHeight: 1.8 }}>
          Les publications PDF seront mises en ligne prochainement.
        </div>
      </section>
      <Footer />
    </div>
